...
<div class='row'>
<div class='col-xs-12'>
<input class='form-control' name="email" placeholder='xxx@aaa.com' title="이메일주소" type="email" readonly="readonly" value="${dto.m_email}">
</div>
</div>
</div>
</div>
<div class='btn-wrap'>
<button class='btn-new btn--type-primary btn--width-100' id="emBtn"  data-gtm-action='이메일로 인증번호 보내기' data-gtm-category='통합인증' disabled id='send-verify-code-btn' type='submit'>이메일로 인증번호 보내기</button>
</div>
</c:when>
...
<c:otherwise>
<div class='form-wrapper'>
<form name="verify_form" class="hidden" role="form" data-validation="true" data-nextpath="/users/verifications/verified?type=phone_new" data-is-invite="false" action="/users/verify" accept-charset="UTF-8" method="post">
<div class='content-wrapper'>
<div class='form-group'>
<div class='content-title-box'>
<div class='sub-title'>
...
<div class='btn-wrap'>
<button class='btn-new btn--type-primary btn--width-100 mobile-mg-rm' data-gtm-action='인증하기' data-gtm-category='통합인증' type="submit" id="sub" value="인증하기">인증하기</button>
</div>
</form>
</div>
</c:otherwise>
